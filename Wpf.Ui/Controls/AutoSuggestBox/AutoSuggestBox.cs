...
/// using a keyboard. The app is notified when text has been changed by the user
...
public class AutoSuggestBox : System.Windows.Controls.ItemsControl, IIconControl
{
    ...
    /// <see cref="AutoSuggestBox"/> is open.
    /// </summary>
    ...
    /// </summary>
    /// <remarks>
    /// The placeholder text to be displayed in the control. The default is an
    /// empty string.
    /// </remarks>
    ...
    /// <summary>
    /// Gets or sets the maximum height for the drop-down portion of the
    /// <see cref="AutoSuggestBox"/> control.
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets a value indicating whether items in the view will trigger
    /// an update of the editable text part of the <see cref="AutoSuggestBox"/>
    /// when clicked.
    /// </summary>
    ...
    {
        // Unsubscribe each handler before subscription, to prevent memory leak
        // from double subscriptions. Unsubscription is safe, even if event has

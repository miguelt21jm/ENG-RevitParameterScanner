...
/// <summary>
/// Extends <see cref="System.Windows.Controls.ListView"/>, and adds customized
/// support <see cref="ListViewViewState.GridView"/> or <see cref="ListViewViewState.Default"/>.
/// </summary>
/// <example>
/// <code lang="xml">
...
public class ListView : System.Windows.Controls.ListView
{
    ...
    /// <summary>
    /// Gets or sets the view state of the <see cref="ListView"/>, enabling
    /// custom logic based on the current view.
    /// </summary>
    /// <value>
    /// The current view state of the <see cref="ListView"/>.
    /// </value>
